...
public class Init implements CommandLineRunner {
    ...
    private void loadStartupData() {
        ...
        Coupon coupon1 = couponRepository.save(new Coupon("coupon1", CouponCategory.FOOD, 10.0F, "Coupon 1 of company 1", Date.valueOf(LocalDate.now()), Date.valueOf(LocalDate.now().plusDays(2)), comp1.getId()));
        Coupon coupon2 = couponRepository.save(new Coupon("coupon2", CouponCategory.FOOD, 10.0F, "Coupon 2 of company 1", Date.valueOf(LocalDate.now()), Date.valueOf(LocalDate.now().plusDays(2)), comp1.getId()));
    }
